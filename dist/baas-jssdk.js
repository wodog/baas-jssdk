(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Baas = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
},{"./baas":2,"./object":4,"./query":5}],4:[function(require,module,exports){
'use strict';
...
module.exports = Baas => {
  ...
  Baas.Object.prototype.fetch = function() {
    ...
    return Baas.api.get(`/tables/${this.tableName}/${_id}?appId=${Baas.appId}`)
      .then(({ data }) => transformResponse(this.tableName, data))
      .then(data => {
  ...
  Baas.Object.prototype.save = function() {
    ...
    return Baas.api[method](`/tables/${this.tableName + (this._id ? '/' + this._id : '')}?appId=${Baas.appId}`, this.$model).then(({ data }) => transformResponse(this.tableName, data));
  };
  Baas.Object.prototype.destroy = function() {
    const { _id } = this;
    if (!_id) throw new InvalidParamsError('_id 属性不能为空');
    return Baas.api.delete(`/tables/${this.tableName}/${_id}?appId=${Baas.appId}`).then(({ data }) => transformResponse(this.tableName, data));
  };
...
module.exports = Baas => {
  class Query {
    ...
    find(query) { return Baas.api.get(`/tables/${this.tableName}?appId=${Baas.appId}`, { params: query || this.queryBuilder }).then(({ data }) => transformResponse(this.tableName, data)); }
    get(id) {
...
},{"./baas":2}],7:[function(require,module,exports){
...
},{"../core/createError":15,"./../core/settle":18,"./../helpers/btoa":22,"./../helpers/buildURL":23,"./../helpers/cookies":25,"./../helpers/isURLSameOrigin":27,"./../helpers/parseHeaders":29,"./../utils":31,"_process":35}],9:[function(require,module,exports){
'use strict';
...
},{"./adapters/http":8,"./adapters/xhr":8,"./helpers/normalizeHeaderName":28,"./utils":31,"_process":35}],21:[function(require,module,exports){
'use strict';
...
},{"./helpers/bind":21,"buffer":33}],32:[function(require,module,exports){
'use strict'
...
},{"base64-js":32,"ieee754":34}],34:[function(require,module,exports){
