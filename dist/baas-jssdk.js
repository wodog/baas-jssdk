...
},{"./api":2,"./baas":3,"./object":5,"./query":6}],5:[function(require,module,exports){
'use strict';
...
module.exports = Baas => {
  ...
  Baas.Object.prototype.get = function(key) {
    ...
    if (!Reflect.has(this, key)) throw new InvalidParamsError('key 不存在');
  ...
  Baas.Object.prototype.clone = function() {
    const { tableName, _id, $model } = this;
    const data = Object.assign({ _id }, $model);
    return new Baas.Object({ tableName, data });
  };
