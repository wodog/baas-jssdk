...
},{"./baas":2,"./file":3,"./object":5,"./query":6}],5:[function(require,module,exports){
'use strict';
...
module.exports = Baas => {
  ...
  Baas.Object.prototype.get = function(key) {
    ...
    if (!Reflect.has(this.$model, key)) throw new InvalidParamsError(`key: ${key} 不存在`);
...
module.exports = Baas => {
  class Query {
    ...
    count(query) { return Baas.api.get(`/tables/${this.tableName}/count`, { params: { query: query || this.queryBuilder } }).then(({ data }) => transformResponse(this.tableName, data)); }
  }
  Baas.Query = Query;
};
...
},{"./baas":2}],8:[function(require,module,exports){
...
},{"../core/createError":16,"./../core/settle":19,"./../helpers/btoa":23,"./../helpers/buildURL":24,"./../helpers/cookies":26,"./../helpers/isURLSameOrigin":28,"./../helpers/parseHeaders":30,"./../utils":32,"_process":36}],10:[function(require,module,exports){
'use strict';
...
},{"./adapters/http":9,"./adapters/xhr":9,"./helpers/normalizeHeaderName":29,"./utils":32,"_process":36}],22:[function(require,module,exports){
'use strict';
...
},{"./helpers/bind":22,"buffer":34}],33:[function(require,module,exports){
'use strict'
