...
module.exports = function(Baas) {
  ...
  Baas.Object.fetchAll = function(objs) {
    ...
    })).then(function(res) { return transformResponse(this.tableName, res.data); });
  };
  ...
  Baas.Object.prototype.save = function() {
    ...
    return Baas.api[method]('/tables/' + this.tableName + (this._id ? '/' + this._id : ''), this.$model).then(function(res) { return transformResponse(this.tableName, res.data); });
  };
  Baas.Object.prototype.destroy = function() {
    var _id = this._id;
    if (!_id) throw new InvalidParamsError('_id 属性不能为空');
    return Baas.api.delete('/tables/' + this.tableName + '/' + _id).then(function(res) { return transformResponse(this.tableName, res.data); });
  };
